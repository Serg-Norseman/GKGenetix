...
#pragma warning restore CS0169, CS0649, IDE0044, IDE0051
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (btnStart.Text == "Start") {
                ...
                if (bwCompare.IsBusy) {
                    MessageBox.Show("Process is busy!", "Please Wait!", MessageBoxButtons.OK, MessageBoxType.Warning);
                } else {
                ...
                if (MessageBox.Show("Are you sure you want to cancel the process?", "Cancel?", MessageBoxButtons.YesNo, MessageBoxType.Question) == DialogResult.Yes) {
                    _host.SetStatus("Done.");
                    _host.SetProgress(-1);
                    bwCompare.CancelAsync();
                    bwROH.CancelAsync();
        ...
        private void WriteStatus(string msg, int progress, bool onlyLocal = false)
        {
            Application.Instance.Invoke(new Action(delegate {
                ...
                txtStatus.Text += $"{msg}\r\n";
                txtStatus.Selection = new Range<int>(txtStatus.Text.Length - 1, txtStatus.Text.Length - 1);
