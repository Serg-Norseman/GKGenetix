...
#pragma warning disable CS0169, CS0649, IDE0044, IDE0051
        ...
        private Label lblKitNo;
        private TabControl tabsNewKit;
        private TabPage tabAutosomal;
        private TabPage tabYDNA;
        private TabPage tabMtDNA;
        private TabControl tabsY;
        private TabPage tabYSNPs;
        private TabPage tabYSTR;
        private GridView dgvAutosomal;
        private TextBox txtName;
        private TextBox txtKit;
        private TextArea txtYDNA;
        private Label lblY37;
        private Label lblY25;
        private Label lblY67;
        private Label lblY111;
        private Label lblYMisc;
        private GridView dgvYMisc;
        private GridView dgvY111;
        private GridView dgvY67;
        private GridView dgvY37;
        private GridView dgvY25;
        private GridView dgvY12;
        private TextArea txtMtDNA;
        private TextArea tipLbl;
        private Label lblY12;
        private Button btnPasteY;
        private Button btnClearY;
        private ContextMenu mnuYDNAMisc;
        private ButtonMenuItem miDeleteRowYDNAMisc;
        private ContextMenu mnuAutosomal;
        private ButtonMenuItem miDeleteRowAutosomal;
        private ButtonMenuItem miClearAllYMisc;
        private ButtonMenuItem miClearAllAutosomal;
        private Label lblSex;
        private ComboBox cbSex;
        private TabControl tabsMt;
...
#pragma warning restore CS0169, CS0649, IDE0044, IDE0051
        ...
        {
            MessageBox.Show("Data Error. Technical Details: " + e.Exception.Message, "Error", MessageBoxButtons.OK, MessageBoxType.Error);
        ...
        private void dgvAutosomal_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Buttons == MouseButtons.Alternate) {
                try {
                    /*var mPt = e.Location;
                    var hti = dgvAutosomal.HitTest(mPt.X, mPt.Y);
        ...
        private void miClearAllAutosomal_Click(object sender, EventArgs e)
        {
            try {
                ...
                MessageBox.Show(err.Message, "Error", MessageBoxButtons.OK, MessageBoxType.Error);
            }
        }
        ...
        private void dgvYMisc_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Buttons == MouseButtons.Alternate) {
                try {
                    /*var mPt = e.Location;
                    var hti = dgvYMisc.HitTest(mPt.X, mPt.Y);
                    dgvYMisc.ClearSelection();
        ...
        private void btnPasteY_Click(object sender, EventArgs e)
        {
            if (Clipboard.Instance.ContainsText) {
                ...
                for (int i = 0; i < 111; i++)
                    stab += "\t";
                string[] ystr = (Clipboard.Instance.Text + stab).TrimStart().Split(new char[] { '\t' });
        ...
        private void SetupYGrid(GridView dgv, string[] markers)
        {
        ...
        public void Save()
        {
            ...
            object[] args = new object[] {
                txtKit.Text, txtName.Text, dgvAutosomal.DataStore, txtYDNA.Text, txtMtDNA.Text, ySTRlist, cbSex.Text, txtFASTA.Text
            };
        ...
        private void bwSave_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try {
                ...
                MessageBox.Show("Not Saved. Techical Details: " + err.Message, "Error", MessageBoxButtons.OK, MessageBoxType.Error);
            }
        }
        ...
        private static void PopulateYGrid(string[] ydna, Dictionary<string, string> ystr_dict, GridView dgv)
        {
